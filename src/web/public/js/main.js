  ...
  \******************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        $(document).ready(function () {
          ...
          try {
            var key = "ca-banner-dismissed";
            var $banner = $(".ca-banner[data-banner='db-warning']");
            if (sessionStorage.getItem(key) === "1") {
              $banner.hide();
            }
            $(document).on("click", ".ca-banner-dismiss", function () {
              var $b = $(this).closest('.ca-banner');
              if ($b && $b.length) {
                sessionStorage.setItem(key, "1");
                $b.slideUp(120);
              }
            });
            // Stop pulsing after 6s to reduce distraction
            setTimeout(function () { $('.ca-banner-icon').css('animation','none'); }, 6000);
          } catch (e) {}
          ...
          $("#dpa").on("changeDate", function (e) {
            ...
            if ($dpb.length) {
              ...
              if (datepicker && typeof datepicker.setStartDate === "function") {
