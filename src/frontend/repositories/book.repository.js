...
class BookFlightsRepository {
  constructor(options) {
    ...
    // const connectionString = `mongodb://${cosmosdb_name}:${encodeURIComponent(
    //   cosmosdb_key
    // )}@${cosmosdb_url}/${database_name}?ssl=true&replicaSet=globaldb`;
  ...
  async getUserInfo(username) {
    ...
    return { user: username, booked: null, purchased: [] };
  }
