...
- Container Registry: `acrdesktop35.azurecr.io` (ACR name stored as secret `AZURE_ACR_NAME`)
- Container Image: ghcr.io/pauldotyu/contoso-air:1.0.0
- Target Port: 3000
- Replicas: 1
- CPU Request: 100m
- CPU Limit: 500m
...
- Build and push the container image using ACR Tasks: `az acr build --registry ${{ secrets.AZURE_ACR_NAME }} --image contoso-air:${{ github.sha }} .`
- Update the container image reference in manifests to use `acrdesktop35.azurecr.io/contoso-air:${{ github.sha }}`
